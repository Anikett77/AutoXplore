...
const Contact = () => {
  return (
    <div
      className="relative min-h-screen flex flex-col items-center justify-center text-white overflow-hidden pt-1"
      id="contact"
    >
      {/* Background Image */}
      <div
      ...
      <div className='relative z-10'>
        <h1 className='text-orange-500 text-5xl text-center font-bold mt-5 flex flex-col justify-center'>Contact Our Team</h1>
        ...
        <div className='flex w-auto h-auto justify-center gap-10 mt-10'>
          ...
          <div className='bg-gray-950/80 w-140 h-120 rounded-2xl border-1 border-gray-600 overflow-hidden'>
            ...
            <div className='grid grid-cols-2'><div className='bg-gray-800 w-60 h-8 ml-8 mr-3 mt-4 border-1 border-gray-700 flex rounded-sm pl-3 items-center font-sans text-sm'><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" className=' fill-amber-500' height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-41.6c0-74.2-60.2-134.4-134.4-134.4z"></path></svg><input className='ml-3' type="name" placeholder='Full Name' /></div>
              <div className='bg-gray-800 w-60 h-8 mt-4 border-1 border-gray-700 flex rounded-sm pl-3 items-center font-sans text-sm'><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className=' fill-amber-500' height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M502.3 190.8c3.9-3.1 9.7-.2 9.7 4.7V400c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V195.6c0-5 5.7-7.8 9.7-4.7 22.4 17.4 52.1 39.5 154.1 113.6 21.1 15.4 56.7 47.8 92.2 47.6 35.7.3 72-32.8 92.3-47.6 102-74.1 131.6-96.3 154-113.7zM256 320c23.2.4 56.6-29.2 73.4-41.4 132.7-96.3 142.8-104.7 173.4-128.7 5.8-4.5 9.2-11.5 9.2-18.9v-19c0-26.5-21.5-48-48-48H48C21.5 64 0 85.5 0 112v19c0 7.4 3.4 14.3 9.2 18.9 30.6 23.9 40.7 32.4 173.4 128.7 16.8 12.2 50.2 41.8 73.4 41.4z"></path></svg><input className='ml-3' type="email" placeholder='Email Address' /></div>
              <div className='bg-gray-800 w-60 h-8 ml-8 mr-3 mt-4 border-1 border-gray-700 flex rounded-sm pl-3 items-center font-sans text-sm'><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className=' fill-amber-500' height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z"></path></svg><input className='ml-3' type="number" placeholder='Phone Number' /></div>
              <div className='bg-gray-800 w-60 h-8 mt-4 border-1 border-gray-700 flex rounded-sm pl-3 items-center font-sans text-sm'><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className=' fill-amber-500' height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M493.4 24.6l-104-24c-11.3-2.6-22.9 3.3-27.5 13.9l-48 112c-4.2 9.8-1.4 21.3 6.9 28l60.6 49.6c-36 76.7-98.9 140.5-177.2 177.2l-49.6-60.6c-6.8-8.3-18.2-11.1-28-6.9l-112 48C3.9 366.5-2 378.1.6 389.4l24 104C27.1 504.2 36.7 512 48 512c256.1 0 464-207.5 464-464 0-11.2-7.7-20.9-18.6-23.4z"></path></svg><input className='ml-3' type="number" placeholder='Phone Number' /></div></div>
            <div className='bg-gray-800 w-auto h-25 ml-8 mr-9.5 mt-4 border-1 border-gray-700 flex rounded-sm pl-3 font-sans'><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className='mt-2.5 mr-3' height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M256 32C114.6 32 0 125.1 0 240c0 49.6 21.4 95 57 130.7C44.5 421.1 2.7 466 2.2 466.5c-2.2 2.3-2.8 5.7-1.5 8.7S4.8 480 8 480c66.3 0 116-31.8 140.6-51.4 32.7 12.3 69 19.4 107.4 19.4 141.4 0 256-93.1 256-208S397.4 32 256 32z"></path></svg><textarea name="message" required="" rows="3" placeholder="Tell us about your rental needs..." class="w-full py-2 text-white rounded-lg focus:outline-none focus:ring-1 focus:ring-orange-500 text-sm transition-all"></textarea></div>
