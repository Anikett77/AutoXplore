...
function BookingModal({ show, onClose, car }) {
  ...
  return (
    <>
      ...
      {/* Modal Container - Higher z-index, centered with padding from top */}
      <div className="fixed inset-0 z-[9999] overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4 pt-20">
          <div 
            className="bg-[#161616] rounded-xl w-full max-w-6xl shadow-2xl relative my-8"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close button */}
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-10 text-gray-400 hover:text-orange-500 text-3xl font-bold bg-gray-800 rounded-full w-10 h-10 flex items-center justify-center transition-colors"
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="md:w-1/2 flex-shrink-0">
                  ...
                  <div className="flex flex-wrap gap-3 mt-3 text-sm text-gray-300">
                    <div className="px-10 py-5 rounded-lg bg-gray-800 text-yellow-400 items-center justify-center flex flex-col">
                      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 640 512" className="text-orange-400 text-xl sm:text-2xl mb-2" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M192 256c61.9 0 112-50.1 112-112S253.9 32 192 32 80 82.1 80 144s50.1 112 112 112zm76.8 32h-8.3c-20.8 10-43.9 16-68.5 16s-47.6-6-68.5-16h-8.3C51.6 288 0 339.6 0 403.2V432c0 26.5 21.5 48 48 48h288c26.5 0 48-21.5 48-48v-28.8c0-63.6-51.6-115.2-115.2-115.2zM480 256c53 0 96-43 96-96s-43-96-96-96-96 43-96 96 43 96 96 96zm48 32h-3.8c-13.9 4.8-28.6 8-44.2 8s-30.3-3.2-44.2-8H432c-20.4 0-39.2 5.9-55.7 15.4 24.4 26.3 39.7 61.2 39.7 99.8v38.4c0 2.2-.5 4.3-.6 6.4H592c26.5 0 48-21.5 48-48 0-61.9-50.1-112-112-112z"></path></svg>
                      <span>Seats: {car.seats || 4}</span>
                    </div>
                    <div className="px-5 py-5 rounded-lg bg-gray-800 text-yellow-400 items-center justify-center flex flex-col">
                      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="text-green-400 text-xl sm:text-2xl mb-2" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M336 448H16c-8.8 0-16 7.2-16 16v32c0 8.8 7.2 16 16 16h320c8.8 0 16-7.2 16-16v-32c0-8.8-7.2-16-16-16zm157.2-340.7l-81-81c-6.2-6.2-16.4-6.2-22.6 0l-11.3 11.3c-6.2 6.2-6.2 16.4 0 22.6L416 97.9V160c0 28.1 20.9 51.3 48 55.2V376c0 13.2-10.8 24-24 24s-24-10.8-24-24v-32c0-48.6-39.4-88-88-88h-8V64c0-35.3-28.7-64-64-64H96C60.7 0 32 28.7 32 64v352h288V304h8c22.1 0 40 17.9 40 40v27.8c0 37.7 27 72 64.5 75.9 43 4.3 79.5-29.5 79.5-71.7V152.6c0-17-6.8-33.3-18.8-45.3zM256 192H96V64h160v128z"></path></svg>
                      <span>Fuel: {car.fuel || car.fuelType || 'Gasoline'}</span>
                    </div>
                    <div className="px-2 py-1 rounded-lg bg-gray-800 text-yellow-400 items-center justify-center flex flex-col">
                      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 576 512" className="text-yellow-400 text-xl sm:text-2xl mb-2" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M288 32C128.94 32 0 160.94 0 320c0 52.8 14.25 102.26 39.06 144.8 5.61 9.62 16.3 15.2 27.44 15.2h443c11.14 0 21.83-5.58 27.44-15.2C561.75 422.26 576 372.8 576 320c0-159.06-128.94-288-288-288zm0 64c14.71 0 26.58 10.13 30.32 23.65-1.11 2.26-2.64 4.23-3.45 6.67l-9.22 27.67c-5.13 3.49-10.97 6.01-17.64 6.01-17.67 0-32-14.33-32-32S270.33 96 288 96zM96 384c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32zm48-160c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32zm246.77-72.41l-61.33 184C343.13 347.33 352 364.54 352 384c0 11.72-3.38 22.55-8.88 32H232.88c-5.5-9.45-8.88-20.28-8.88-32 0-33.94 26.5-61.43 59.9-63.59l61.34-184.01c4.17-12.56 17.73-19.45 30.36-15.17 12.57 4.19 19.35 17.79 15.17 30.36zm14.66 57.2l15.52-46.55c3.47-1.29 7.13-2.23 11.05-2.23 17.67 0 32 14.33 32 32s-14.33 32-32 32c-11.38-.01-20.89-6.28-26.57-15.22zM480 384c-17.67 0-32-14.33-32-32s14.33-32 32-32 32 14.33 32 32-14.33 32-32 32z"></path></svg>
                      <span>Mileage: {car.mileage || 0}</span>
                    </div>
                    <div className="px-2 py-1 rounded-lg bg-gray-800 text-yellow-400 items-center justify-center flex flex-col">
                      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="text-purple-400 text-xl sm:text-2xl mb-2" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M504 256c0 136.967-111.033 248-248 248S8 392.967 8 256 119.033 8 256 8s248 111.033 248 248zM227.314 387.314l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.249-16.379-6.249-22.628 0L216 308.118l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.249 16.379 6.249 22.628.001z"></path></svg>
                      <span>Trans: {car.transmission || 'Automatic'}</span>
                    </div>
                  </div>
                ...
                <div className="md:w-1/2 bg-gray-900 rounded-2xl p-6">
                  ...
                  <form onSubmit={handleSubmit} className="mt-5 space-y-4 text-sm">
                    ...
                    <button
                      type="submit"
                      className="w-full mt-3 bg-gradient-to-r from-orange-400 to-orange-600 py-2 rounded text-white font-bold hover:from-orange-500 hover:to-orange-700 transition-all"
                    >
                      Confirm Booking
                    </button>
                  </form>
