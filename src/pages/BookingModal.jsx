      ...
      <div className="bg-[#161616] rounded-xl w-full max-w-6xl max-h-[100vh] overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden p-6 relative shadow-2xl">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="md:w-1/2 flex-shrink-0">
            ...
            />
            <h2 className="text-3xl text-start font-extrabold text-orange-400 mt-4">{car.name}</h2>
            <h1 className="text-2xl text-start font-extrabold text-green-400 mt-4">₹{car.price}</h1>
            ...
            <div className="bg-gray-800 w-full mt-5 h-auto text-start rounded-lg">
              ...
              <p className="pl-3 pb-3 text-sm text-gray-300">{car.about}</p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-4 text-sm">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <label className="flex flex-col text-gray-200">
                  ...
                  <input
                    ...
                    required
                    className="mt-1 px-3 py-2 rounded-lg bg-gray-700 text-white"
                  />
                </label>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 gap-3">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="px-3 py-2 rounded-lg bg-gray-700 flex flex-col text-white"
              ...
              <div className="text-start flex flex-col justify-between px-3 my-4 ">
                <span className="flex justify-between text-gray-300">Rate/day <p>₹{car.price}</p> </span>
                <div className="bg-gray-500 w-full h-0.25 mt-1 "></div>
                <span className="flex justify-between text-white">Total<p>₹{car.price}</p></span>
              </div>
              </div>
